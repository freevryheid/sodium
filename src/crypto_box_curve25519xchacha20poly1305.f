module mod_crypto_box_curve25519xchacha20poly1305
  ...
  interface
    ...
    end function crypto_box_curve25519xchacha20poly1305_seed_keypair
    ...
    result(res)
      ...
      integer(kind=c_int) res
      character(kind=c_char) pk, sk
    end function crypto_box_curve25519xchacha20poly1305_keypair
    ...
    end function crypto_box_curve25519xchacha20poly1305_easy
    ...
    result(res)
      ...
      character(kind=c_char) n, pk, sk
    end function crypto_box_curve25519xchacha20poly1305_open_easy
    ...
    result(res)
      ...
      integer(kind=c_long_long), value :: mlen
      character(kind=c_char) n, pk, sk
    end function crypto_box_curve25519xchacha20poly1305_detached
    ...
    result(res)
      ...
      integer(kind=c_long_long), value :: clen
      character(kind=c_char) n, pk, sk
    end function crypto_box_curve25519xchacha20poly1305_open_detached
    ...
    result(res)
      ...
      character(kind=c_char) pk, sk
    end function crypto_box_curve25519xchacha20poly1305_beforenm
    ...
    end function crypto_box_curve25519xchacha20poly1305_easy_afternm
    ...
    result(res)
      ...
      integer(kind=c_long_long), value :: clen
      character(kind=c_char) n, k
    end function crypto_box_curve25519xchacha20poly1305_open_easy_afternm
    ...
    result(res)
      ...
      integer(kind=c_long_long), value :: mlen
      character(kind=c_char) n, k
    end function crypto_box_curve25519xchacha20poly1305_detached_afternm
    ...
    result(res)
      ...
      integer(kind=c_long_long), value :: clen
      character(kind=c_char) n, k
    end function crypto_box_curve25519xchacha20poly1305_open_detached_afternm
    ...
    result(res)
      import c_size_t
      integer(kind=c_size_t) res
    end function crypto_box_curve25519xchacha20poly1305_sealbytes
    ...
    end function crypto_box_curve25519xchacha20poly1305_seal
