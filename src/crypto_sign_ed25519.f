module mod_crypto_sign_ed25519
  ...
  integer(kind=c_size_t), parameter, public :: SODIUM_crypto_sign_ed25519_BYTES            = 64
  integer(kind=c_size_t), parameter, public :: SODIUM_crypto_sign_ed25519_SEEDBYTES        = 32
  integer(kind=c_size_t), parameter, public :: SODIUM_crypto_sign_ed25519_PUBLICKEYBYTES   = 32
  integer(kind=c_size_t), parameter, public :: SODIUM_crypto_sign_ed25519_SECRETKEYBYTES   = 64
  integer(kind=c_size_t), parameter, public :: SODIUM_crypto_sign_ed25519_MESSAGEBYTES_MAX = &
    (SODIUM_SIZE_MAX - SODIUM_crypto_sign_ed25519_BYTES)
...
end module mod_crypto_sign_ed25519
