module mod_crypto_sign_edwards25519sha512batch
  ...
  interface
    ...
    end function crypto_sign_edwards25519sha512batch
    ...
    end function crypto_sign_edwards25519sha512batch_open
    ...
    end function crypto_sign_edwards25519sha512batch_keypair

  end interface

end module mod_crypto_sign_edwards25519sha512batch
