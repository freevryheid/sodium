module mod_crypto_core_ed25519
	...
	interface
		...
		endfunction crypto_core_ed25519_bytes
		...
		&result(res)
			import::c_size_t
			integer(kind=c_size_t)::res
		endfunction crypto_core_ed25519_uniformbytes
		...
		&result(res)
			import::c_size_t
			integer(kind=c_size_t)::res
		endfunction crypto_core_ed25519_hashbytes
		...
		&result(res)
			import::c_size_t
			integer(kind=c_size_t)::res
		endfunction crypto_core_ed25519_scalarbytes
		...
		&result(res)
			import::c_size_t
			integer(kind=c_size_t)::res
		endfunction crypto_core_ed25519_nonreducedscalarbytes
		...
		endfunction crypto_core_ed25519_is_valid_point
		...
		endfunction crypto_core_ed25519_add
		...
		&result(res)
			...
			integer(kind=c_int)::res
			character(kind=c_char)::r,p,q
		endfunction crypto_core_ed25519_sub
		...
		endfunction crypto_core_ed25519_from_uniform
		...
		endfunction crypto_core_ed25519_scalar_invert
		...
		endsubroutine crypto_core_ed25519_scalar_negate
