module mod_crypto_aead_chacha20poly1305
 ...
 ! #define crypto_aead_chacha20poly1305_IETF_MESSAGEBYTES_MAX crypto_aead_chacha20poly1305_ietf_MESSAGEBYTES_MAX
	...
	interface
		...
		endfunction crypto_aead_chacha20poly1305_ietf_keybytes
		...
		&result(res)
			import::c_size_t
			integer(kind=c_size_t)::res
		endfunction crypto_aead_chacha20poly1305_ietf_nsecbytes
		...
		&result(res)
			import::c_size_t
			integer(kind=c_size_t)::res
		endfunction crypto_aead_chacha20poly1305_ietf_npubbytes
		...
		&result(res)
			import::c_size_t
			integer(kind=c_size_t)::res
		endfunction crypto_aead_chacha20poly1305_ietf_abytes
		...
		&result(res)
			import::c_size_t
			integer(kind=c_size_t)::res
		endfunction crypto_aead_chacha20poly1305_ietf_messagebytes_max
		...
		endfunction crypto_aead_chacha20poly1305_ietf_encrypt
		...
		&result(res)
			...
			character(kind=c_char)::nsec,npub,k
		endfunction crypto_aead_chacha20poly1305_ietf_decrypt
		...
		&result(res)
			...
			integer(kind=c_long_long),value::mlen,adlen
			character(kind=c_char)::nsec,npub,k
		endfunction crypto_aead_chacha20poly1305_ietf_encrypt_detached
		...
		&result(res)
			...
			integer(kind=c_long_long),value::clen,adlen
			character(kind=c_char)::nsec,npub,k
		endfunction crypto_aead_chacha20poly1305_ietf_decrypt_detached

		subroutine crypto_aead_chacha20poly1305_ietf_keygen(k)&
		&bind(c,name='crypto_aead_chacha20poly1305_ietf_keygen')
			import::c_char
			character(kind=c_char)::k
		endsubroutine crypto_aead_chacha20poly1305_ietf_keygen
		...
		&result(res)
			import::c_size_t
			integer(kind=c_size_t)::res
		endfunction crypto_aead_chacha20poly1305_keybytes
		...
		&result(res)
			import::c_size_t
			integer(kind=c_size_t)::res
		endfunction crypto_aead_chacha20poly1305_nsecbytes
		...
		&result(res)
			import::c_size_t
			integer(kind=c_size_t)::res
		endfunction crypto_aead_chacha20poly1305_npubbytes
		...
		&result(res)
			import::c_size_t
			integer(kind=c_size_t)::res
		endfunction crypto_aead_chacha20poly1305_abytes
		...
		&result(res)
			import::c_size_t
			integer(kind=c_size_t)::res
		endfunction crypto_aead_chacha20poly1305_messagebytes_max
		...
		&result(res)
			...
			integer(kind=c_long_long),value::mlen,adlen
			character(kind=c_char)::nsec,npub,k
		endfunction crypto_aead_chacha20poly1305_encrypt
		...
		&result(res)
			...
			integer(kind=c_long_long),value::clen,adlen
			character(kind=c_char)::nsec,npub,k
		endfunction crypto_aead_chacha20poly1305_decrypt
		...
		&result(res)
			...
			integer(kind=c_long_long),value::mlen,adlen
			character(kind=c_char)::nsec,npub,k
		endfunction crypto_aead_chacha20poly1305_encrypt_detached
		...
		&result(res)
			...
			integer(kind=c_long_long),value::clen,adlen
			character(kind=c_char)::nsec,npub,k
		endfunction crypto_aead_chacha20poly1305_decrypt_detached

		subroutine crypto_aead_chacha20poly1305_keygen(k)&
		&bind(c,name='crypto_aead_chacha20poly1305_keygen')
			import::c_char
			character(kind=c_char)::k
		endsubroutine crypto_aead_chacha20poly1305_keygen
