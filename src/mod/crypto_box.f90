module mod_crypto_box
	...
	interface
		...
		endfunction crypto_box_seedbytes
		...
		&result(res)
			import::c_size_t
			integer(kind=c_size_t)::res
		endfunction crypto_box_publickeybytes
		...
		&result(res)
			import::c_size_t
			integer(kind=c_size_t)::res
		endfunction crypto_box_secretkeybytes
		...
		&result(res)
			import::c_size_t
			integer(kind=c_size_t)::res
		endfunction crypto_box_noncebytes
		...
		&result(res)
			import::c_size_t
			integer(kind=c_size_t)::res
		endfunction crypto_box_macbytes
		...
		&result(res)
			import::c_size_t
			integer(kind=c_size_t)::res
		endfunction crypto_box_messagebytes_max
		...
		&result(res)
			import::c_ptr
			type(c_ptr)::res
		endfunction bind_crypto_box_primitive
		...
		endfunction crypto_box_seed_keypair
		...
		&result(res)
			...
			integer(kind=c_int)::res
			character(kind=c_char)::pk,sk
		endfunction crypto_box_keypair
		...
		&result(res)
			...
			character(kind=c_char)::n,pk,sk
		endfunction crypto_box_open_easy
		...
		&result(res)
			...
			integer(kind=c_long_long),value::mlen
			character(kind=c_char)::n,pk,sk
		endfunction crypto_box_detached
		...
		&result(res)
			...
			integer(kind=c_long_long),value::clen
			character(kind=c_char)::n,pk,sk
		endfunction crypto_box_open_detached
		...
		&result(res)
			import c_size_t
			integer(kind=c_size_t)::res
		endfunction crypto_box_beforenmbytes
		...
		&result(res)
			...
			character(kind=c_char)::pk,sk
		endfunction crypto_box_beforenm
		...
		endfunction crypto_box_easy_afternm
		...
		&result(res)
			...
			integer(kind=c_long_long),value::clen
			character(kind=c_char)::n,k
		endfunction crypto_box_open_easy_afternm
		...
		&result(res)
			...
			integer(kind=c_long_long),value::mlen
			character(kind=c_char)::n,k
		endfunction crypto_box_detached_afternm
		...
		&result(res)
			...
			integer(kind=c_long_long),value::clen
			character(kind=c_char)::n,k
		endfunction crypto_box_open_detached_afternm
		...
		&result(res)
			import c_size_t
			integer(kind=c_size_t)::res
		endfunction crypto_box_sealbytes
		...
		&result(res)
			...
			integer(kind=c_long_long),value::clen
			character(kind=c_char)::pk,sk
		endfunction crypto_box_seal_open
		...
		&result(res)
			import c_size_t
			integer(kind=c_size_t)::res
		endfunction crypto_box_zerobytes
		...
		&result(res)
			import c_size_t
			integer(kind=c_size_t)::res
		endfunction crypto_box_boxzerobytes
		...
		&result(res)
			...
			integer(kind=c_long_long),value::mlen
			character(kind=c_char)::n,k
		endfunction crypto_box_afternm
		...
		&result(res)
			...
			integer(kind=c_long_long),value::clen
			character(kind=c_char)::n,k
		endfunction crypto_box_open_afternm
	...
	contains
		...
		endfunction crypto_box_primitive

endmodule mod_crypto_box
