module mod_crypto_stream_salsa20
	...
	interface
		...
		endfunction crypto_stream_salsa20_keybytes
		...
		&result(res)
			import::c_size_t
			integer(kind=c_size_t)::res
		endfunction crypto_stream_salsa20_noncebytes
		...
		&result(res)
			import::c_size_t
			integer(kind=c_size_t)::res
		endfunction crypto_stream_salsa20_messagebytes_max
		...
		endfunction crypto_stream_salsa20
		...
		&result(res)
			...
			character(kind=c_char)::n,k
		endfunction crypto_stream_salsa20_xor
		...
		endfunction crypto_stream_salsa20_xor_ic

		subroutine crypto_stream_salsa20_keygen(k)&
		&bind(c,name='crypto_stream_salsa20_keygen')
			import::c_char
			character(kind=c_char)::k
		endsubroutine crypto_stream_salsa20_keygen

	endinterface

endmodule mod_crypto_stream_salsa20
