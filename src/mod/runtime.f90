module mod_runtime
	...
	interface
		...
		endfunction sodium_runtime_has_neon
		...
		&result(res)
			import::c_int
			integer(kind=c_int)::res
		endfunction sodium_runtime_has_sse2
		...
		&result(res)
			import::c_int
			integer(kind=c_int)::res
		endfunction sodium_runtime_has_sse3
		...
		&result(res)
			import::c_int
			integer(kind=c_int)::res
		endfunction sodium_runtime_has_ssse3
		...
		&result(res)
			import::c_int
			integer(kind=c_int)::res
		endfunction sodium_runtime_has_sse41
		...
		&result(res)
			import::c_int
			integer(kind=c_int)::res
		endfunction sodium_runtime_has_avx
		...
		&result(res)
			import::c_int
			integer(kind=c_int)::res
		endfunction sodium_runtime_has_avx2
		...
		&result(res)
			import::c_int
			integer(kind=c_int)::res
		endfunction sodium_runtime_has_avx512f
		...
		&result(res)
			import::c_int
			integer(kind=c_int)::res
		endfunction sodium_runtime_has_pclmul
		...
		&result(res)
			import::c_int
			integer(kind=c_int)::res
		endfunction sodium_runtime_has_aesni
		...
		&result(res)
			import::c_int
			integer(kind=c_int)::res
		endfunction sodium_runtime_has_rdrand

	endinterface

endmodule mod_runtime
