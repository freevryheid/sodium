module mod_crypto_box_curve25519xsalsa20poly1305
 ...
 ! #define crypto_box_curve25519xsalsa20poly1305_BOXZEROBYTES 16U
	...
	interface
		...
		endfunction crypto_box_curve25519xsalsa20poly1305_seedbytes
		...
		&result(res)
			import::c_size_t
			integer(kind=c_size_t)::res
		endfunction crypto_box_curve25519xsalsa20poly1305_publickeybytes
		...
		&result(res)
			import::c_size_t
			integer(kind=c_size_t)::res
		endfunction crypto_box_curve25519xsalsa20poly1305_secretkeybytes
		...
		&result(res)
			import::c_size_t
			integer(kind=c_size_t)::res
		endfunction crypto_box_curve25519xsalsa20poly1305_beforenmbytes
		...
		&result(res)
			import::c_size_t
			integer(kind=c_size_t)::res
		endfunction crypto_box_curve25519xsalsa20poly1305_noncebytes
		...
		&result(res)
			import::c_size_t
			integer(kind=c_size_t)::res
		endfunction crypto_box_curve25519xsalsa20poly1305_macbytes
		...
		&result(res)
			import::c_size_t
			integer(kind=c_size_t)::res
		endfunction crypto_box_curve25519xsalsa20poly1305_messagebytes_max
		...
		endfunction crypto_box_curve25519xsalsa20poly1305_seed_keypair
		...
		&result(res)
			...
			integer(kind=c_int)::res
			character(kind=c_char)::pk,sk
		endfunction crypto_box_curve25519xsalsa20poly1305_keypair
		...
		&result(res)
			...
			character(kind=c_char)::pk,sk
		endfunction crypto_box_curve25519xsalsa20poly1305_beforenm
		...
		&result(res)
			import::c_size_t
			integer(kind=c_size_t)::res
		endfunction crypto_box_curve25519xsalsa20poly1305_boxzerobytes
		...
		&result(res)
			import::c_size_t
			integer(kind=c_size_t)::res
		endfunction crypto_box_curve25519xsalsa20poly1305_zerobytes
		...
		endfunction crypto_box_curve25519xsalsa20poly1305
		...
		&result(res)
			...
			character(kind=c_char)::n,pk,sk
		endfunction crypto_box_curve25519xsalsa20poly1305_open
		...
		endfunction crypto_box_curve25519xsalsa20poly1305_afternm
		...
		&result(res)
			...
			integer(kind=c_long_long),value::clen
			character(kind=c_char)::n,k
		endfunction crypto_box_curve25519xsalsa20poly1305_open_afternm

	endinterface

endmodule mod_crypto_box_curve25519xsalsa20poly1305
