module mod_crypto_stream_xsalsa20
	...
	interface
		...
		endfunction crypto_stream_xsalsa20_keybytes
		...
		&result(res)
			import::c_size_t
			integer(kind=c_size_t)::res
		endfunction crypto_stream_xsalsa20_noncebytes
		...
		&result(res)
			import::c_size_t
			integer(kind=c_size_t)::res
		endfunction crypto_stream_xsalsa20_messagebytes_max
		...
		endfunction crypto_stream_xsalsa20
		...
		&result(res)
			...
			character(kind=c_char)::n,k
		endfunction crypto_stream_xsalsa20_xor
