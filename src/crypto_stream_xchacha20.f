module mod_crypto_stream_xchacha20
  ...
  integer(kind=c_size_t), parameter, public :: SODIUM_crypto_stream_xchacha20_KEYBYTES         = 32
  integer(kind=c_size_t), parameter, public :: SODIUM_crypto_stream_xchacha20_NONCEBYTES       = 24
  integer(kind=c_size_t), parameter, public :: SODIUM_crypto_stream_xchacha20_MESSAGEBYTES_MAX = SODIUM_SIZE_MAX
  ...
  interface
    ...
    end function crypto_stream_xchacha20_keybytes
    ...
    result(res)
      import c_size_t
      integer(kind=c_size_t) res
    end function crypto_stream_xchacha20_noncebytes
    ...
    result(res)
      import c_size_t
      integer(kind=c_size_t) res
    end function crypto_stream_xchacha20_messagebytes_max
    ...
    end function crypto_stream_xchacha20
    ...
    result(res)
      ...
      character(kind=c_char) n, k
    end function crypto_stream_xchacha20_xor
    ...
    end function crypto_stream_xchacha20_xor_ic

    subroutine crypto_stream_xchacha20_keygen(k) &
    bind(c, name='crypto_stream_xchacha20_keygen')
      import c_char
      character(kind=c_char) k
    end subroutine crypto_stream_xchacha20_keygen

  end interface

end module mod_crypto_stream_xchacha20
